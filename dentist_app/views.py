...
from .forms import DentistForm,AppointmentForm,ServiceForm,ContactMessageForm,NewsletterForm
from .models import Appointment,Dentist,Service,ContactMessage
...
def appointment_other(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'dentist_app/appointment_other.html',{})
